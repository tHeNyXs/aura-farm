...
const RAW_CROP_DATABASE: CropRequirement[] = [
  ...
  },
  {
    ...
    category: "ไม้ผลเศรษฐกิจ",
    icon_emoji: "🍒",
    image_url: "/images/crops/rambutan.jpg",
    growth_duration: "ให้ผลผลิตปีที่ 4 เป็นต้นไป",
    water_requirement: "สูง",
    water_level: 3,
    estimated_yield: "ขึ้นอยู่กับพันธุ์และการจัดการแปลง",
    ideal_temperature_range: "ตามสภาพพื้นที่",
    best_season: "เก็บเกี่ยวตามฤดูกาลของพื้นที่",
    soil_preference: "ดินลึก ระบายน้ำดี",
    description: "ผลการประเมินใช้เกณฑ์ความเหมาะสมที่ดินสำหรับเงาะจากไฟล์เกณฑ์ FAO ที่กำหนด",
    source_citation: "เกณฑ์ความเหมาะสมที่ดิน_13พืชเศรษฐกิจ_FAO.xlsx",
    pros_template: ["ประเมินจากความลาดชัน ปริมาณฝน และค่า pH ที่ระบบตรวจวัดได้"],
    cautions_template: ["ยังไม่ประเมินเนื้อดิน การระบายน้ำ และความลึกดิน หากไม่มีข้อมูลภาคสนาม"],
    ideal_moisture_min: 0,
    ideal_moisture_max: 100,
    max_slope: 25,
    ideal_elevation_min: 0,
    ideal_elevation_max: 3000,
    ideal_rainfall_min: 1200,
    ideal_rainfall_max: 3000,
    ideal_ndvi_min: 0,
    soil_depth_min_cm: 0,
    ldd_criteria: {
      slope_deg: { s1: [0, 4.6], s2: [4.6, 8.5], s3: [8.5, 14.0] },
      soil_ph: { s1: [5.5, 6.5], s2: [5.0, 7.2], s3: [4.5, 7.8] },
      soil_moisture: { s1: [0, 100], s2: [0, 100], s3: [0, 100] },
      annual_rainfall: { s1: [2000, 3000], s2: [1500, 2000], s3: [1200, 1500] },
    },
    suitable_soil_groups_s1: [],
    suitable_soil_groups_s2: [],
    forbidden_soil_groups: [],
    favored_regions: ["south", "east"],
  },
  {
    id: "longan",
