...
export const CROP_DATABASE: CropRequirement[] = [
  ...
  },
  {
    ...
    soil_depth_min_cm: 50,
    ldd_criteria: {
      slope_deg: { s1: [1.0, 4.0], s2: [4.0, 7.0], s3: [7.0, 12.0] },
  ...
  // ==========================================
  {
    ...
    ldd_criteria: {
      slope_deg: { s1: [1.5, 6.0], s2: [6.0, 10.0], s3: [10.0, 15.0] },
  ...
  },
  {
    ...
    ldd_criteria: {
      slope_deg: { s1: [0.5, 4.0], s2: [4.0, 7.0], s3: [7.0, 12.0] },
  ...
  },
  {
    ...
    soil_depth_min_cm: 80,
    ldd_criteria: {
      slope_deg: { s1: [1.5, 5.5], s2: [5.5, 9.0], s3: [9.0, 14.0] },
  ...
  },
  {
    ...
    soil_depth_min_cm: 80,
    ldd_criteria: {
      slope_deg: { s1: [2.0, 7.0], s2: [7.0, 12.0], s3: [12.0, 18.0] },
  ...
  },
  {
    ...
    ldd_criteria: {
      slope_deg: { s1: [1.0, 4.5], s2: [0.5, 1.0], s3: [4.5, 8.0] },
  ...
  },
  {
    ...
    ldd_criteria: {
      slope_deg: { s1: [1.0, 4.5], s2: [4.5, 8.0], s3: [8.0, 12.0] },
...
export function evaluateCropByLDDMatrix(
  ...
  // Check elevation if required (e.g. Arabica Coffee)
  if (crop.ideal_elevation_min && params.elevationAmsl && params.elevationAmsl < crop.ideal_elevation_min) {
    const reason = `ระดับความสูง (${params.elevationAmsl} ม.) ต่ำกว่าเกณฑ์พืชที่สูง (${crop.ideal_elevation_min} ม.)`;
    return {
      fao_class: "N",
      fao_label: "ไม่แนะนำ (N)",
      match_percentage: 25,
