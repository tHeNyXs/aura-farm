  ...
  return (
    <div className="aura-report-page flex flex-col min-h-screen bg-[var(--bg-base)] text-[var(--text-main)] transition-colors duration-300">
      ...
      <main className="flex-1 max-w-6xl w-full mx-auto px-4 sm:px-6 md:px-8 py-8 flex flex-col gap-10">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 pb-6 border-b border-[var(--border-soft)]">
          <div className="flex flex-col gap-2">
            <div className="flex items-center gap-2 text-xs font-semibold text-emerald-500">
              ...
              <span className="text-[var(--text-muted)] font-medium">รายงานประเมินความเหมาะสมที่ดิน GIS AI</span>
            </div>
            <h1 className="font-heading font-black text-3xl md:text-4xl text-[var(--text-main)] tracking-tight">
              {data.location_name}
            </h1>
            <div className="flex flex-wrap items-center gap-3 text-xs text-[var(--text-muted)] pt-1">
              <span className="px-3 py-1 bg-emerald-500/10 border border-emerald-500/30 rounded-full font-bold text-emerald-400 shadow-2xs flex items-center gap-1.5">
              ...
              <span>•</span>
              <span className="text-[var(--text-muted)] font-mono">{data.coordinates.formatted}</span>
              <span>•</span>
              <span className="text-[var(--text-muted)]">สำรวจเมื่อ: {data.analyzed_date}</span>
            </div>
          </div>
        ...
        <div className={`relative overflow-hidden rounded-3xl bg-gradient-to-br ${heroTheme.bg} text-white p-8 md:p-10 shadow-2xl border transition-all duration-500 glass-specular`}>
        ...
        <div className="flex flex-col gap-4">
          <div className="flex items-center justify-between">
            <h3 className="font-heading font-bold text-xl text-[var(--text-main)] tracking-tight flex items-center gap-2">
            ...
            <span className="text-xs text-[var(--text-muted)] font-medium">Sentinel-2, Sentinel-1, SRTM & CHIRPS</span>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            
            {/* Stat Card 1: NDVI */}
            <div className="bg-[var(--bg-surface)] border border-[var(--border-soft)] rounded-2xl p-5 flex flex-col justify-between gap-4 shadow-sm hover:shadow-md hover:border-emerald-500/50 transition-all group glass-specular">
              <div className="flex items-start justify-between">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl bg-emerald-500/10 border border-emerald-500/20 text-emerald-500 flex items-center justify-center group-hover:scale-105 transition-transform">
                  ...
                  <div>
                    <span className="text-xs font-bold text-[var(--text-muted)] block">ดัชนีพืชพรรณ</span>
                    <span className="font-heading font-bold text-base text-[var(--text-main)]">NDVI (10m)</span>
                  </div>
                </div>
              </div>
              <div className="flex flex-col gap-2">
                <div className="flex items-baseline justify-between">
                  <span className="font-mono font-black text-2xl text-emerald-500">{data.ndvi_value}</span>
            ...
            <div className="bg-[var(--bg-surface)] border border-[var(--border-soft)] rounded-2xl p-5 flex flex-col justify-between gap-4 shadow-sm hover:shadow-md hover:border-sky-500/50 transition-all group glass-specular">
              <div className="flex items-start justify-between">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl bg-sky-500/10 border border-sky-500/20 text-sky-500 flex items-center justify-center group-hover:scale-105 transition-transform">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                      <path d="M12 22a7 7 0 0 0 7-7c0-2-1-3.9-3-5.5s-3.5-4-4-6.5c-.5 2.5-2 4.9-4 6.5C6 11.1 5 13 5 15a7 7 0 0 0 7 7z" />
                    </svg>
                  </div>
                  <div>
                    <span className="text-xs font-bold text-[var(--text-muted)] block">ความชื้นดิน</span>
                    <span className="font-heading font-bold text-base text-[var(--text-main)]">SAR Radar</span>
                  </div>
                </div>
              </div>
              <div className="flex flex-col gap-2">
                <div className="flex items-baseline justify-between">
                  <span className="font-mono font-black text-2xl text-sky-400">{data.soil_moisture}%</span>
                  <span className="text-[11px] font-semibold text-sky-400 bg-sky-500/10 px-2 py-0.5 rounded-full border border-sky-500/30">
            ...
            <div className="bg-[var(--bg-surface)] border border-[var(--border-soft)] rounded-2xl p-5 flex flex-col justify-between gap-4 shadow-sm hover:shadow-md hover:border-amber-500/50 transition-all group glass-specular">
              <div className="flex items-start justify-between">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl bg-amber-500/10 border border-amber-500/20 text-amber-500 flex items-center justify-center group-hover:scale-105 transition-transform">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                      <path d="m8 3 4 8 5-5 5 15H2L8 3z" />
                    </svg>
                  </div>
                  <div>
                    <span className="text-xs font-bold text-[var(--text-muted)] block">ความลาดชัน</span>
                    <span className="font-heading font-bold text-base text-[var(--text-main)]">SRTM DEM</span>
                  </div>
                </div>
              </div>
              <div className="flex flex-col gap-2">
                <div className="flex items-baseline justify-between">
                  <span className="font-mono font-black text-2xl text-amber-400">{data.slope_degrees}°</span>
                  <span className="text-[11px] font-semibold text-amber-400 bg-amber-500/10 px-2 py-0.5 rounded-full border border-amber-500/30">
            ...
            <div className="bg-[var(--bg-surface)] border border-[var(--border-soft)] rounded-2xl p-5 flex flex-col justify-between gap-4 shadow-sm hover:shadow-md hover:border-blue-500/50 transition-all group glass-specular">
              <div className="flex items-start justify-between">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl bg-blue-500/10 border border-blue-500/20 text-blue-500 flex items-center justify-center group-hover:scale-105 transition-transform">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  ...
                  <div>
                    <span className="text-xs font-bold text-[var(--text-muted)] block">ฝนสะสมรายปี</span>
                    <span className="font-heading font-bold text-base text-[var(--text-main)]">CHIRPS (~5km)</span>
                  </div>
                </div>
              </div>
              <div className="flex flex-col gap-2">
                <div className="flex items-baseline justify-between">
                  <span className="font-mono font-black text-2xl text-blue-400">{data.rainfall_mm} <span className="text-xs font-normal">มม.</span></span>
                  <span className="text-[11px] font-semibold text-blue-400 bg-blue-500/10 px-2 py-0.5 rounded-full border border-blue-500/30">
        ...
        {data.soil_group && (
          <div className="bg-[var(--bg-surface)] border border-[var(--border-soft)] rounded-3xl p-6 md:p-8 flex flex-col gap-6 shadow-sm glass-specular">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-[var(--border-soft)]">
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-2xl bg-amber-500/10 border border-amber-500/30 flex items-center justify-center text-amber-500 shrink-0 shadow-2xs">
                ...
                <div>
                  <h3 className="font-heading font-bold text-xl text-[var(--text-main)] tracking-tight">
              ...
              <span className="px-4 py-1.5 bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 text-xs font-bold rounded-xl self-start sm:self-auto shadow-2xs">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 text-xs">
              ...
              {/* Texture Spec */}
              <div className="bg-[var(--bg-base)] border border-[var(--border-soft)] rounded-2xl p-4 flex items-start gap-3 hover:border-emerald-500/50 transition-colors">
                ...
                <div className="flex flex-col gap-0.5">
                  <span className="text-[11px] text-[var(--text-muted)] font-semibold block">เนื้อดิน (Texture)</span>
                  <span className="font-bold text-[var(--text-main)] text-sm">{data.soil_group.texture}</span>
                </div>
              </div>
              ...
              <div className="bg-[var(--bg-base)] border border-[var(--border-soft)] rounded-2xl p-4 flex items-start gap-3 hover:border-emerald-500/50 transition-colors">
                <div className="w-9 h-9 rounded-xl bg-sky-500/10 border border-sky-500/20 text-sky-500 flex items-center justify-center shrink-0">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M2 12c1.66-1.5 3.33-1.5 5 0 1.67 1.5 3.33 1.5 5 0 1.67-1.5 3.33-1.5 5 0 1.67 1.5 3.33 1.5 5 0" />
                    <path d="M2 17c1.66-1.5 3.33-1.5 5 0 1.67 1.5 3.33 1.5 5 0 1.67-1.5 3.33-1.5 5 0 1.67 1.5 3.33 1.5 5 0" />
                  </svg>
                </div>
                <div className="flex flex-col gap-0.5">
                  <span className="text-[11px] text-[var(--text-muted)] font-semibold block">การระบายน้ำ (Drainage)</span>
                  <span className="font-bold text-[var(--text-main)] text-sm">{data.soil_group.drainageTh}</span>
                </div>
              </div>
              ...
              <div className="bg-[var(--bg-base)] border border-[var(--border-soft)] rounded-2xl p-4 flex items-start gap-3 hover:border-emerald-500/50 transition-colors">
                ...
                <div className="flex flex-col gap-0.5">
                  <span className="text-[11px] text-[var(--text-muted)] font-semibold block">ความเป็นกรด-ด่าง (Soil pH)</span>
                  <span className="font-bold text-[var(--text-main)] text-sm">{data.soil_ph ? `pH ${data.soil_ph}` : data.soil_group.phLabel}</span>
                </div>
              </div>
              ...
              <div className="bg-[var(--bg-base)] border border-[var(--border-soft)] rounded-2xl p-4 flex items-start gap-3 hover:border-emerald-500/50 transition-colors">
                ...
                <div className="flex flex-col gap-0.5">
                  <span className="text-[11px] text-[var(--text-muted)] font-semibold block">ความลึกหน้าดิน (Depth)</span>
                  <span className="font-bold text-[var(--text-main)] text-sm">{data.soil_group.depthTh}</span>
                </div>
              </div>

            </div>

            <div className="text-xs text-[var(--text-main)] leading-relaxed bg-emerald-500/10 p-4 rounded-2xl border border-emerald-500/20 flex items-start gap-3">
              ...
              <div>
                <strong className="text-emerald-400 font-bold">คำแนะนำทางปฐพีวิทยา: </strong>
